...
CONFIG_VERSION = "dynamic_world_v1"
...
LOCAL_TARGET_RADIUS = 3
LOCAL_TARGET_BONUS = 2.0
SWEEP_STICKINESS = 1.5

OPPORTUNISTIC_RETURN_MARGIN = 8.0
OPPORTUNISTIC_MAX_EXTRA_COST = 15.0
OPPORTUNISTIC_MIN_CABBAGES = 3
